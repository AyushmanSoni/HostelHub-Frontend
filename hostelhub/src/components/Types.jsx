  ...
  return (
    <div>
        ...
        <div className='flex mt-8'>
            ...
            <button className='text-white bg-[#304AC1] hover:font-semibold hover:bg-[#EFF5FF] hover:text-[#091553] border w-20 h-10 items-center rounded '>Log Out</button>
        </div>
        <div>
            <div className='pt-12'>
            ...
            <div className='flex justify-center pt-16 gap-16'>
               <Link to = "/double">
                ...
                <button className='py-3.5 w-72 sm:w-72 rounded-lg bg-[#304AC1] text-[#ffffff] font-semibold text-2xl sm:text-lg hover:bg-[#435cd0]'>Single Room</button>
            </div>
        </div>
    </div>
    <AboutDouble/>
